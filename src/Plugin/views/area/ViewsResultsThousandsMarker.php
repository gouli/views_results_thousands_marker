...
namespace Drupal\views_results_thousands_marker\Plugin\views\area;
 ...
 *
 * @ViewsArea("views_results_thousands_marker")
 */
class ViewsResultsThousandsMarker extends AreaPluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['views_results_thousands_marker'] = [
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['views_results_thousands_marker'] = [
      '#title' => $this->t('Display'),
      '#type' => 'textarea',
      '#rows' => 3,
      '#default_value' => $this->options['views_results_thousands_marker'],
  ...
  public function query() {
    if (strpos($this->options['views_results_thousands_marker'], '@total') !== FALSE) {
  ...
  public function render($empty = FALSE) {
    ...
    if (!isset($this->options['views_results_thousands_marker']) || $this->view->style_plugin instanceof DefaultSummary) {
      return [];
    }
    $output = '';
    $format = $this->options['views_results_thousands_marker'];
    ...
    $replacements = [];
    $replacements['@start'] = number_format($start);
    $replacements['@end'] = number_format($end);
